    ...
    */
    public function datasource(): ?Builder
    {
        return Transaction::query()
            ...
            ->join('users as driver', 'transactions.driver', '=', 'driver.id')
            ->join('users as approvedBy', 'transactions.approvedBy', '=', 'approvedBy.id')
            ->join('suppliers', 'transactions.supplier', '=', 'suppliers.id')
            ->select('transactions.*', 'products.name as product', 'vehicles.regNo as vehicle', 'driver.name as driver', 'approvedBy.name as approvedBy', 'suppliers.name as supplier')
            ->latest('id');
    }
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('updated_at_formatted', function(Transaction $model) { 
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ->title('PRODUCT')
                ->field('product')
                ->makeInputSelect(Product::all(), 'name', 'products.id'),

            Column::add()
                ->title('VEHICLE')
                ->field('vehicle')
                ->makeInputSelect(Vehicle::all(), 'regNo', 'vehicles.id'),

            Column::add()
                ->title('DRIVER')
                ->field('driver')
                ->makeInputSelect(User::where('role', '=', 'driver')->get(), 'name', 'driver.id'),
            ...
            Column::add()
                ->title('APPROVEDBY')
                ->field('approvedBy')
                ->makeInputSelect(User::where('role', '=', 'admin')->get(), 'name', 'approvedBy.id'),
            ...
            Column::add()
                ->title('SUPPLIER')
                ->field('supplier')
                ->makeInputSelect(Supplier::all(), 'name', 'suppliers.id'),
